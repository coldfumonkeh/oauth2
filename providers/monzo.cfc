component extends="oauth2" accessors="true" {
	...
	/**
	* I return an initialized monzo object instance.
	...
	**/
	public monzo function init(
		required string client_id,
		required string authEndpoint        = 'https: //auth.monzo.com/', 
		required string accessTokenEndpoint = 'https: //api.monzo.com/oauth2/token',

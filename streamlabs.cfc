component extends="oauth2" accessors="true" {
	...
	/**
	* I return an initialized streamlabs object instance.
	...
	**/
	public streamlabs function init(
		required string client_id,
		required string client_secret,
		required string authEndpoint        = 'https://streamlabs.com/api/v1.0/authorize', 
		required string accessTokenEndpoint = 'https://streamlabs.com/api/v1.0/token',

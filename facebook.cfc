component extends="oauth2" accessors="true" {
	...
	**/
	public facebook function init(
		...
		required string authEndpoint = 'https://www.facebook.com/v2.10/dialog/oauth', 
		required string accessTokenEndpoint = 'https://graph.facebook.com/v2.10/oauth/access_token',
